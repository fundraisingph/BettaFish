...
- `data_flow_analysis.md` - Detailed analysis of system data flow and interactions
...
"[Memory Bank: Active] I understand we're working on BettaFish, a multi-agent public opinion analysis system. Currently implementing [specific feature] that needs to work with the existing agent architecture."
...
## BettaFish-Specific Considerations

For the BettaFish multi-agent public opinion analysis system, pay special attention to:

- Multi-agent architecture patterns and agent coordination
- Flask orchestrator and SocketIO real-time communication
- Database operations with PostgreSQL and SQLAlchemy
- LLM integrations with multiple providers (OpenAI, Moonshot, DeepSeek, etc.)
- Report generation workflows with HTML/PDF output
- Social media crawling via MindSpider
- ForumEngine collaboration mechanisms
- Docker deployment and containerization

When working on BettaFish, always consider the impact of changes on:
- Parallel execution of agents
- Real-time communication and progress monitoring
