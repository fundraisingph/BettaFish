...
Integrates complete workflow and command-line tools for topic extraction
"""
...
class BroadTopicExtraction:
    ...
    async def run_daily_extraction(self,
        ...
        extraction_result_message += f"Keyword count: Maximum {max_keywords}\n"
...
def main():
    ...
    parser.add_argument("--list-sources", action="store_true", help="Display supported news sources")
    
    args = parser.parse_args()
    
    # Display supported news sources
