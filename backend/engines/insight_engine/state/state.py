...
@dataclass
class Research:
    """State of paragraph research process"""
    search_history: List[Search] = field(default_factory=list)     # Search record list
    latest_summary: str = ""                                       # Current paragraph's latest summary
...
class Paragraph:
    ...
    content: str = ""                                              # Paragraph's expected content (initial planning)
...
class ResearchState:
    ...
    id: str = field(default_factory=lambda: str(uuid.uuid4()))  # Unique research ID
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ResearchState":
        """Create ResearchState object from dictionary"""
    ...
    def from_json(cls, json_str: str) -> "ResearchState":
        """Create ResearchState object from JSON string"""
    ...
    @classmethod
    async def load_from_file(cls, filepath: str) -> "ResearchState":
